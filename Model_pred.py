...
def main(a, b, c):
 ...
 xg_reg = joblib.load('S2647direct+reverse')
 #feature labels
 ...
 test_model(a, b, c, seq_id, mut_data, gen_file_dir, feature_label, xg_reg, outdir, outfile)


def test_model(a, b, c, uniq_id, mut_data, dir, feature_label, xg_reg, outdir, outfile):
 #Testing Model
 pdbidc_last = 'NA'
 features_list = []
 mut_list = []
 for r in mut_data:
    ...
    if uniq_id != pdbidc_last:
        pdbidc_last = uniq_id
        features_list.append(Feature_extract.features(uniq_id, mut_seqpos, wild_res, mut_res, 0, a, b, c, '25', '7', dir))
        #features_list.append(Feature_extract.features(pdbidc, mut_seqpos, mut_res, wild_res, 0, a, b, c, r[8], r[9], neg_ddg))
    else:
        features_list.append(Feature_extract.features(uniq_id, mut_seqpos, wild_res, mut_res, 1, a, b, c, '25', '7', dir))
